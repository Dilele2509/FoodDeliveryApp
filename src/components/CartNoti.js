    ...
    return (
        <View style={styles.container}>
            <View style={[{flexDirection: "row", alignItems: "center"}]}>
                <FontAwesome6 style={styles.cart} name="basket-shopping" size={28} color={primaryColor.organPrimary} />
                <Text style={[{color: primaryColor.organPrimary, fontWeight: "500", fontSize: 16, lineHeight: 50}]}>x{cartCount}</Text>
            </View>
