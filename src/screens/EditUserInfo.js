                ...
                <>
                    ...
                    <View style={[styles.contentContainer]}>
                        ...
                        <View style={[styles.InfoArea]}>
                            <View style={[{ flexDirection: "row", alignItems: "center" }, GlobalStyles.mb10]}>
                                <Text style={[GlobalStyles.h5, { color: primaryColor.organPrimary, marginRight: 10 }]}>Email: </Text>
                                {isEdit ? (
                                    <TextInput
                                        style={[styles.inputStyle, styles.mt15, GlobalStyles.alightSelfCenter, isFocus && styles.inputFocus]}
                            ...
                            <View style={[{ flexDirection: "row", alignItems: "center" }, GlobalStyles.mb10]}>
                                <Text style={[GlobalStyles.h5, { color: primaryColor.organPrimary, marginRight: 10 }]}>Phone number: </Text>
                                {isEdit ? (
                                    <TextInput
                                        style={[styles.inputStyle, styles.mt15, GlobalStyles.alightSelfCenter, isFocus && styles.inputFocus]}
                            ...
                            <View style={[{ flexDirection: "row", alignItems: "center" }, GlobalStyles.mb10]}>
                                <Text style={[GlobalStyles.h5, { color: primaryColor.organPrimary, marginRight: 10 }]}>Address: </Text>
                                {isEdit ? (
                                    <TextInput
                                        style={[styles.inputStyle, styles.mt15, GlobalStyles.alightSelfCenter, isFocus && styles.inputFocus]}
                    ...
                    {!isEdit ? (
                        <View style={{ alignItems: "center" }}>
                            <FillButton onPress={() => setIsEdit(true)} color={primaryColor.whitePrimary} backgroundColor={primaryColor.organPrimary} text="Edit Information" />
                        </View>
                    ) : (
                        <>
                            <View style={{ alignItems: "center" }}>
                                <FillButton onPress={handleSaveEdit} color={primaryColor.whitePrimary} backgroundColor={primaryColor.organPrimary} text="Save Edit" />
                            </View>
