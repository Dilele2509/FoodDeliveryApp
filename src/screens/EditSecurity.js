                ...
                {checkPass ? (
                    <>
                        <View style={[{ alignItems: "center" }]}>
                            <FillButton onPress={handleSaveEdit} color={primaryColor.whitePrimary} backgroundColor={primaryColor.organPrimary} text="Save Change" />
                        </View>
                    ...
                    <View style={[{ alignItems: "center", marginTop: 20 }]}>
                        <FillButton onPress={checkCurrentPass} color={primaryColor.whitePrimary} backgroundColor={primaryColor.organPrimary} text="Change Password" />
                    </View>
                )}
            </>)}
        </SafeAreaView>
